...
// butonlar.appendChild(chinaBtn)
// chinaBtn.classList.add("btn", "btn-outline-dark", "btn-item")
// chinaBtn.id = "chinaBtn"

const section = document.querySelector(".section-center");
const btnContainer = document.querySelector(".btn-container");


const categories = menu.reduce((ilkdeger, ikincideger) => {
  if (!ilkdeger.includes(ikincideger.category)) {
    ilkdeger.push(ikincideger.category)
  }
  return ilkdeger
}, ["All"]);
